...
const SYNC_SUBCOMMITTEE_SIZE: usize = 128;
...
fn run_shared_mainnet_type<T: SszDecode + SszEncode + HashTreeRoot + std::fmt::Debug>(
    type_name: &str,
) {
    run_mainnet_type_for_forks::<T>(type_name, MAINNET_FORKS);
}

fn run_mainnet_type_for_forks<T: SszDecode + SszEncode + HashTreeRoot + std::fmt::Debug>(
    type_name: &str,
    forks: &[&str],
) {
    let mut found_any = false;
    for fork in forks {
        let cases = loader::ssz_static_cases(Archive::Mainnet, fork, type_name);
        if cases.is_empty() {
            continue;
        }
        found_any = true;
...
#[test]
fn mainnet_shared_fork() {
    run_shared_mainnet_type::<Fork>("Fork");
}

#[test]
fn mainnet_shared_fork_data() {
    run_shared_mainnet_type::<ForkData>("ForkData");
}

#[test]
fn mainnet_shared_checkpoint() {
    run_shared_mainnet_type::<Checkpoint>("Checkpoint");
}

#[test]
fn mainnet_shared_beacon_block_header() {
    run_shared_mainnet_type::<BeaconBlockHeader>("BeaconBlockHeader");
}

#[test]
fn mainnet_shared_signed_beacon_block_header() {
    run_shared_mainnet_type::<SignedBeaconBlockHeader>("SignedBeaconBlockHeader");
}

#[test]
fn mainnet_shared_signing_data() {
    run_shared_mainnet_type::<SigningData>("SigningData");
}

#[test]
fn mainnet_shared_voluntary_exit() {
    run_shared_mainnet_type::<VoluntaryExit>("VoluntaryExit");
}

#[test]
fn mainnet_shared_signed_voluntary_exit() {
    run_shared_mainnet_type::<SignedVoluntaryExit>("SignedVoluntaryExit");
}

#[test]
fn mainnet_shared_deposit_message() {
    run_shared_mainnet_type::<DepositMessage>("DepositMessage");
}

#[test]
fn mainnet_shared_deposit_data() {
    run_shared_mainnet_type::<DepositData>("DepositData");
}

#[test]
fn mainnet_shared_eth1_data() {
    run_shared_mainnet_type::<Eth1Data>("Eth1Data");
}

#[test]
fn mainnet_shared_eth1_block() {
    run_shared_mainnet_type::<Eth1Block>("Eth1Block");
}

#[test]
fn mainnet_shared_validator() {
    run_shared_mainnet_type::<Validator>("Validator");
}

#[test]
fn mainnet_shared_attestation_data() {
    run_shared_mainnet_type::<AttestationData>("AttestationData");
}

#[test]
fn mainnet_shared_indexed_attestation() {
    run_mainnet_type_for_forks::<IndexedAttestation>(
        "IndexedAttestation",
...
#[test]
fn mainnet_shared_pending_attestation() {
    run_shared_mainnet_type::<PendingAttestation>("PendingAttestation");
}

#[test]
fn mainnet_shared_attestation() {
    run_mainnet_type_for_forks::<Attestation>("Attestation", LEGACY_ATTESTATION_FORKS);
}

#[test]
fn mainnet_shared_proposer_slashing() {
    run_shared_mainnet_type::<ProposerSlashing>("ProposerSlashing");
}

#[test]
fn mainnet_shared_attester_slashing() {
    run_mainnet_type_for_forks::<AttesterSlashing>("AttesterSlashing", LEGACY_ATTESTATION_FORKS);
}

#[test]
fn mainnet_shared_aggregate_and_proof() {
    run_mainnet_type_for_forks::<AggregateAndProof>("AggregateAndProof", LEGACY_ATTESTATION_FORKS);
}

#[test]
fn mainnet_shared_signed_aggregate_and_proof() {
    run_mainnet_type_for_forks::<SignedAggregateAndProof>(
...
#[test]
fn mainnet_shared_deposit() {
    run_shared_mainnet_type::<Deposit>("Deposit");
}

#[test]
fn mainnet_shared_historical_batch() {
    run_shared_mainnet_type::<HistoricalBatch>("HistoricalBatch");
}

#[test]
fn mainnet_phase0_beacon_block_body() {
    run_mainnet_type_for_forks::<Phase0BeaconBlockBody>("BeaconBlockBody", &["phase0"]);
}

#[test]
fn mainnet_phase0_beacon_block() {
    run_mainnet_type_for_forks::<Phase0BeaconBlock>("BeaconBlock", &["phase0"]);
}

#[test]
fn mainnet_phase0_signed_beacon_block() {
    run_mainnet_type_for_forks::<Phase0SignedBeaconBlock>("SignedBeaconBlock", &["phase0"]);
}

#[test]
fn mainnet_phase0_beacon_state() {
    run_mainnet_type_for_forks::<Phase0BeaconState>("BeaconState", &["phase0"]);
}

#[test]
fn mainnet_altair_beacon_block_body() {
    run_mainnet_type_for_forks::<AltairBeaconBlockBody>("BeaconBlockBody", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_beacon_block() {
    run_mainnet_type_for_forks::<AltairBeaconBlock>("BeaconBlock", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_signed_beacon_block() {
    run_mainnet_type_for_forks::<AltairSignedBeaconBlock>("SignedBeaconBlock", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_beacon_state() {
    run_mainnet_type_for_forks::<AltairBeaconState>("BeaconState", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_bellatrix_pow_block() {
    run_mainnet_type_for_forks::<PowBlock>("PowBlock", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_execution_payload() {
    run_mainnet_type_for_forks::<ExecutionPayload>("ExecutionPayload", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_execution_payload_header() {
    run_mainnet_type_for_forks::<ExecutionPayloadHeader>("ExecutionPayloadHeader", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_beacon_block_body() {
    run_mainnet_type_for_forks::<BellatrixBeaconBlockBody>("BeaconBlockBody", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_beacon_block() {
    run_mainnet_type_for_forks::<BellatrixBeaconBlock>("BeaconBlock", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_signed_beacon_block() {
    run_mainnet_type_for_forks::<BellatrixSignedBeaconBlock>("SignedBeaconBlock", &["bellatrix"]);
}

#[test]
fn mainnet_bellatrix_beacon_state() {
    run_mainnet_type_for_forks::<BellatrixBeaconState>("BeaconState", &["bellatrix"]);
}

#[test]
fn mainnet_capella_withdrawal() {
    run_mainnet_type_for_forks::<Withdrawal>("Withdrawal", &["capella"]);
}

#[test]
fn mainnet_capella_bls_to_execution_change() {
    run_mainnet_type_for_forks::<BLSToExecutionChange>("BLSToExecutionChange", &["capella"]);
}

#[test]
fn mainnet_capella_signed_bls_to_execution_change() {
    run_mainnet_type_for_forks::<SignedBLSToExecutionChange>(
        "SignedBLSToExecutionChange",
        &["capella"],
    );
}
...
#[test]
fn mainnet_capella_historical_summary() {
    run_mainnet_type_for_forks::<HistoricalSummary>("HistoricalSummary", &["capella"]);
}

#[test]
fn mainnet_capella_execution_payload() {
    run_mainnet_type_for_forks::<CapellaExecutionPayload>("ExecutionPayload", &["capella"]);
}

#[test]
fn mainnet_capella_execution_payload_header() {
    run_mainnet_type_for_forks::<CapellaExecutionPayloadHeader>(
...
#[test]
fn mainnet_capella_beacon_block_body() {
    run_mainnet_type_for_forks::<CapellaBeaconBlockBody>("BeaconBlockBody", &["capella"]);
}

#[test]
fn mainnet_capella_beacon_block() {
    run_mainnet_type_for_forks::<CapellaBeaconBlock>("BeaconBlock", &["capella"]);
}

#[test]
fn mainnet_capella_signed_beacon_block() {
    run_mainnet_type_for_forks::<CapellaSignedBeaconBlock>("SignedBeaconBlock", &["capella"]);
}

#[test]
fn mainnet_capella_light_client_header() {
    run_mainnet_type_for_forks::<CapellaLightClientHeader>("LightClientHeader", &["capella"]);
}

#[test]
fn mainnet_capella_light_client_bootstrap() {
    run_mainnet_type_for_forks::<CapellaLightClientBootstrap>("LightClientBootstrap", &["capella"]);
}

#[test]
fn mainnet_capella_light_client_update() {
    run_mainnet_type_for_forks::<CapellaLightClientUpdate>("LightClientUpdate", &["capella"]);
}

#[test]
fn mainnet_capella_light_client_finality_update() {
    run_mainnet_type_for_forks::<CapellaLightClientFinalityUpdate>(
...
#[test]
fn mainnet_capella_light_client_optimistic_update() {
    run_mainnet_type_for_forks::<CapellaLightClientOptimisticUpdate>(
...
#[test]
fn mainnet_capella_beacon_state() {
    run_mainnet_type_for_forks::<CapellaBeaconState>("BeaconState", &["capella"]);
}

#[test]
fn mainnet_deneb_blob_identifier() {
    run_mainnet_type_for_forks::<BlobIdentifier>("BlobIdentifier", &["deneb"]);
}

#[test]
fn mainnet_deneb_blob_sidecar() {
    run_mainnet_type_for_forks::<BlobSidecar>("BlobSidecar", &["deneb"]);
}

#[test]
fn mainnet_deneb_execution_payload() {
    run_mainnet_type_for_forks::<DenebExecutionPayload>("ExecutionPayload", &["deneb"]);
}

#[test]
fn mainnet_deneb_execution_payload_header() {
    run_mainnet_type_for_forks::<DenebExecutionPayloadHeader>("ExecutionPayloadHeader", &["deneb"]);
}

#[test]
fn mainnet_deneb_beacon_block_body() {
    run_mainnet_type_for_forks::<DenebBeaconBlockBody>("BeaconBlockBody", &["deneb"]);
}

#[test]
fn mainnet_deneb_beacon_block() {
    run_mainnet_type_for_forks::<DenebBeaconBlock>("BeaconBlock", &["deneb"]);
}

#[test]
fn mainnet_deneb_signed_beacon_block() {
    run_mainnet_type_for_forks::<DenebSignedBeaconBlock>("SignedBeaconBlock", &["deneb"]);
}

#[test]
fn mainnet_deneb_light_client_header() {
    run_mainnet_type_for_forks::<DenebLightClientHeader>("LightClientHeader", &["deneb"]);
}

#[test]
fn mainnet_deneb_light_client_bootstrap() {
    run_mainnet_type_for_forks::<DenebLightClientBootstrap>("LightClientBootstrap", &["deneb"]);
}

#[test]
fn mainnet_deneb_light_client_update() {
    run_mainnet_type_for_forks::<DenebLightClientUpdate>("LightClientUpdate", &["deneb"]);
}

#[test]
fn mainnet_deneb_light_client_finality_update() {
    run_mainnet_type_for_forks::<DenebLightClientFinalityUpdate>(
        "LightClientFinalityUpdate",
        &["deneb"],
    );
}
...
#[test]
fn mainnet_deneb_light_client_optimistic_update() {
    run_mainnet_type_for_forks::<DenebLightClientOptimisticUpdate>(
        "LightClientOptimisticUpdate",
        &["deneb"],
    );
}
...
#[test]
fn mainnet_deneb_beacon_state() {
    run_mainnet_type_for_forks::<DenebBeaconState>("BeaconState", &["deneb"]);
}

#[test]
fn mainnet_altair_plus_sync_aggregate() {
    run_mainnet_type_for_forks::<SyncAggregate>("SyncAggregate", ALTAIR_PLUS_FORKS);
}

#[test]
fn mainnet_altair_plus_sync_committee() {
    run_mainnet_type_for_forks::<SyncCommittee>("SyncCommittee", ALTAIR_PLUS_FORKS);
}

#[test]
fn mainnet_altair_plus_sync_committee_message() {
    run_mainnet_type_for_forks::<SyncCommitteeMessage>("SyncCommitteeMessage", ALTAIR_PLUS_FORKS);
}

#[test]
fn mainnet_altair_plus_sync_committee_contribution() {
    run_mainnet_type_for_forks::<SyncCommitteeContribution>(
...
#[test]
fn mainnet_altair_plus_contribution_and_proof() {
    run_mainnet_type_for_forks::<ContributionAndProof>("ContributionAndProof", ALTAIR_PLUS_FORKS);
}

#[test]
fn mainnet_altair_plus_signed_contribution_and_proof() {
    run_mainnet_type_for_forks::<SignedContributionAndProof>(
...
#[test]
fn mainnet_altair_plus_sync_aggregator_selection_data() {
    run_mainnet_type_for_forks::<SyncAggregatorSelectionData>(
...
#[test]
fn mainnet_altair_light_client_header() {
    run_mainnet_type_for_forks::<LightClientHeader>("LightClientHeader", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_light_client_bootstrap() {
    run_mainnet_type_for_forks::<LightClientBootstrap>("LightClientBootstrap", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_light_client_update() {
    run_mainnet_type_for_forks::<LightClientUpdate>("LightClientUpdate", ALTAIR_ONLY_FORKS);
}

#[test]
fn mainnet_altair_light_client_finality_update() {
    run_mainnet_type_for_forks::<LightClientFinalityUpdate>(
        "LightClientFinalityUpdate",
        ALTAIR_ONLY_FORKS,
    );
}
...
#[test]
fn mainnet_altair_light_client_optimistic_update() {
    run_mainnet_type_for_forks::<LightClientOptimisticUpdate>(
        "LightClientOptimisticUpdate",
        ALTAIR_ONLY_FORKS,
    );
}
